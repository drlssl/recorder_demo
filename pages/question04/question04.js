...
Page({
  ...
  next: function () {
    ...
    util.uploadTopic(chosenTopic, 'question04', wx.getStorageSync('stuID'), this.success, this.data.nextQuestion)
  },
  ...
  upload: function () {
    ...
    this.startSetInter()
    util.uploadToServer(this.data.tempFilePath, wx.getStorageSync('stuID'), 'question04',
