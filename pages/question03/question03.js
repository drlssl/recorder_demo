...
Page({
  ...
  next: function () {
    ...
    util.uploadTopic(chosenTopic, 'question03', wx.getStorageSync('stuID'), this.success, this.data.nextQuestion)
  },
  ...
  click: function () {
    this.stopVoice()
    wx.redirectTo({
      url: '/pages/preparation04/preparation04'
    })
  },
  ...
  upload: function () {
    ...
    this.startSetInter()
    util.uploadToServer(this.data.tempFilePath, wx.getStorageSync('stuID'), 'question03',
